...
describe('WhatsAppChannel', () => {
    ...
    describe('connection lifecycle', () => {
        ...
        it('flushes outgoing queue on reconnect', async () => {
            ...
            expect(fakeSocket.sendMessage).toHaveBeenCalledWith('test@g.us', { text: 'Queued message' });
        });
    ...
    describe('message handling', () => {
        it('delivers message for registered group', async () => {
            ...
            expect(opts.onChatMetadata).toHaveBeenCalledWith('registered@g.us', expect.any(String));
        ...
        it('only emits metadata for unregistered groups', async () => {
            ...
            expect(opts.onChatMetadata).toHaveBeenCalledWith('unregistered@g.us', expect.any(String));
        ...
        it('handles message with no extractable text (e.g. voice note without caption)', async () => {
            ...
            expect(opts.onMessage).toHaveBeenCalledWith('registered@g.us', expect.objectContaining({ content: '' }));
        });
    ...
    describe('LID to JID translation', () => {
        it('translates known LID to phone JID', async () => {
            ...
            expect(opts.onChatMetadata).toHaveBeenCalledWith('1234567890@s.whatsapp.net', expect.any(String));
        });
        ...
        it('passes through unknown LID JIDs unchanged', async () => {
            ...
            expect(opts.onChatMetadata).toHaveBeenCalledWith('0000000000@lid', expect.any(String));
        });
    });
