...
import { ASSISTANT_NAME, DATA_DIR, IPC_POLL_INTERVAL, MAIN_GROUP_FOLDER, TIMEZONE, } from './config.js';
                            ...
                            if (data.type === 'message' && data.chatJid && data.text) {
                                ...
                                if (isMain ||
                                    ...
                                    if (fs.existsSync(hostImagePath)) {
                                        ...
                                        logger.info({ chatJid: data.chatJid, sourceGroup, filePath: data.filePath }, 'IPC image sent');
                                        try {
                                        ...
                                        logger.warn({ hostImagePath, sourceGroup }, 'IPC image file not found');
                                    }
                                }
                                else {
